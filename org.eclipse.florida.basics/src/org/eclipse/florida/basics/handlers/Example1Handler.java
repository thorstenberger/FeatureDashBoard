package org.eclipse.florida.basics.handlers;
 ...
 */
public class Example1Handler extends AbstractHandler {
	...
	private void createLinks_AnnotationsFM() throws CoreException, IOException {
		...
		FM_AnnotationsFactory MyFactory = FM_AnnotationsFactory.eINSTANCE;
		...
		if(!org.eclipse.capra.testsuite.TestHelper.projectExists("FloridaMiddleModel") )
			MiddleModelProject = createSimpleProject("FloridaMiddleModel");
		else
			MiddleModelProject = getProject("FloridaMiddleModel");	
