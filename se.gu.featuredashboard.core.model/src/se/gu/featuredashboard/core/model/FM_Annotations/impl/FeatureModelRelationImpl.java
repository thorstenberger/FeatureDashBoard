 ...
 * </p>
 * <ul>
 *   <li>{@link se.gu.featuredashboard.core.model.FM_Annotations.impl.FeatureModelRelationImpl#getFeature <em>Feature</em>}</li>
 *   <li>{@link se.gu.featuredashboard.core.model.FM_Annotations.impl.FeatureModelRelationImpl#getRelationID <em>Relation ID</em>}</li>
 *   <li>{@link se.gu.featuredashboard.core.model.FM_Annotations.impl.FeatureModelRelationImpl#getFormula <em>Formula</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FeatureModelRelationImpl extends MinimalEObjectImpl.Container implements FeatureModelRelation {
	...
	protected EClass eStaticClass() {
		return AnnotationsPackage.Literals.FEATURE_MODEL_RELATION;
	}
	...
	public EList<Feature> getFeature() {
		if (feature == null) {
			feature = new EObjectResolvingEList<Feature>(Feature.class, this, AnnotationsPackage.FEATURE_MODEL_RELATION__FEATURE);
		}
		return feature;
	}
	...
	public void setRelationID(int newRelationID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnnotationsPackage.FEATURE_MODEL_RELATION__RELATION_ID, oldRelationID, relationID));
	}
	...
	public void setFormula(String newFormula) {
		...
		formula = newFormula;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnnotationsPackage.FEATURE_MODEL_RELATION__FORMULA, oldFormula, formula));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AnnotationsPackage.FEATURE_MODEL_RELATION__FEATURE:
				return getFeature();
			case AnnotationsPackage.FEATURE_MODEL_RELATION__RELATION_ID:
				return getRelationID();
			case AnnotationsPackage.FEATURE_MODEL_RELATION__FORMULA:
				return getFormula();
		}
